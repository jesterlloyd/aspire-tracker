...
export const SETTINGS_SECTIONS = [
  ...
  { key: 'about',      label: 'About',             path: '/settings/about',      group: 'Workspace',      implemented: true,  inRail: true, visible: () => true }, // SETTINGS-UNIFIED-DESIGN-1: build/deployment metadata, moved out of General
