...
export default function AccountDetailsDrawer({ kind, record, returnFocusRef, onClose, onEditStaff, onRenewPortal, onRevoked }) {
  ...
  const doRevoke = async () => {
    ...
    try {
      ...
      // nursing_academic and talent_acquisition own no scope rows: the grant itself is the whole revocation.
            ...
            <Section title="Portal Access">
              <dl style={row}>
                ...
                {record.portal_role === 'talent_acquisition' && (
                  <><dt style={dt}>Access scope</dt><dd style={dd}>All residency cohorts</dd></>
                )}
