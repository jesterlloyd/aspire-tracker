...
const BLANK = {
  name: '', school_email: '', personal_email: '', phone: '',
...
export default function AddStudentModal({ cohortId, onAdd, onClose }) {
  ...
  const handleSubmit = async e => {
    ...
    const err = await onAdd({ ...form, cohort_id: cohortId })
          ...
          <div className="modal-body">
            ...
            <div className="form-grid form-grid-2">
              <div className="form-field">
                ...
                <input className="form-input" value={form.name} onChange={e => set('name', e.target.value)} placeholder="First Last" autoFocus />
              </div>
              <div className="form-field">
                <label className="form-label">School Email</label>
                <input className="form-input" value={form.school_email} onChange={e => set('school_email', e.target.value)} placeholder="student@school.edu" />
              </div>
            </div>
            ...
            <div className="form-grid form-grid-3">
              <div className="form-field">
                ...
                <input className="form-input" value={form.term_dates} onChange={e => set('term_dates', e.target.value)} placeholder="Auto-filled by school" />
              </div>
              <div className="form-field">
                <label className="form-label">Hours Required</label>
                <input className="form-input" type="number" min="0" value={form.hours_required || ''} onChange={e => set('hours_required', parseInt(e.target.value) || 0)} />
              </div>
              <div className="form-field">
            ...
            {form.coordinators && (
              <div className="form-field">
                ...
                <textarea className="form-textarea" rows={2} value={form.coordinators} onChange={e => set('coordinators', e.target.value)} />
              </div>
            )}
          </div>
