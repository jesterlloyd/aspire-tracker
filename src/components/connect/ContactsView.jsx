...
const ROLE_COLORS = {
  ...
  'Unit Leader':        { color: '#166534', bg: '#EEF7F0', border: '#c6d9a8' },
  'Executive':          { color: '#92400e', bg: '#FEF3C7', border: '#fde68a' },
  'BNI Team':           { color: '#7C3AED', bg: '#F5F3FF', border: '#DDD6FE' },
}
    ...
    >
      <div style={{
        ...
        <div style={{
          ...
          fontSize: 11, fontWeight: 700, color: isSelected ? '#fff' : '#6b7280',
          fontFamily: F,
        }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{
            fontWeight: 600, fontSize: 13, color: '#191919', fontFamily: F,
          ...
          <div style={{
            fontSize: 11, color: '#6b7280', fontFamily: F, lineHeight: 1.3,
            whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis',
          }}>
...
function ContactDetail({ contact, commHistory, loadingComm, linkedStudents, loadingStudents }) {
  ...
  return (
    <div>
      ...
      {/* Affiliation */}
      {(contact.school_name || contact.program_type || contact.unit_name) && (
        <div style={{
          background: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: 10,
          padding: '14px 16px', marginBottom: 18,
        }}>
          ...
          {contact.school_name && (
            <div style={{ display: 'flex', gap: 8, marginBottom: 6 }}>
              <span style={{ fontSize: 11, color: '#9ca3af', width: 70, fontFamily: F, flexShrink: 0 }}>School</span>
          ...
          {contact.unit_name && (
            <div style={{ display: 'flex', gap: 8 }}>
              <span style={{ fontSize: 11, color: '#9ca3af', width: 70, fontFamily: F, flexShrink: 0 }}>Unit</span>
      ...
      {contact.notes && (
        <div style={{
          ...
          <div style={{ fontSize: 13, color: '#374151', fontFamily: F, lineHeight: 1.6, whiteSpace: 'pre-wrap' }}>
            {contact.notes}
          </div>
        </div>
      )}
  ...
  return (
    <div style={{ display: 'flex', height: '100%', fontFamily: F, overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        {roles.length > 2 && (
          <div style={{
            padding: '0 14px 10px', display: 'flex', gap: 5, flexWrap: 'wrap',
          }}>
            {roles.map(r => (
              <button
                key={r}
                ...
                style={{
                  ...
                  background: roleFilter === r ? NAVY : '#f3f4f6',
        ...
        {/* Count */}
        <div style={{ padding: '2px 14px 8px', fontSize: 11, color: '#9ca3af', fontFamily: F }}>
          {loading ? 'Loading…' : error ? 'Failed to load' : `${filtered.length} contact${filtered.length !== 1 ? 's' : ''}`}
        </div>
