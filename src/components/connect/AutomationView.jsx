...
const AUTOMATION_CARDS = [
  ...
  { id: 'cohort_access_retirement', title: 'CS-Link Access Retirement',
    cron_name: 'cohort-access-retirement', automation_key: 'cohort_access_retirement',
    scope: 'All cohorts', schedule: 'Business day after cohort completion · 9:00 AM PT', hasGlobalSetting: true,
    desc: 'When a cohort is marked Completed, notifies Nursing Academics which students\u2019 Hybrid Student Nurse CS-Link accesses are ready to retire.' },
