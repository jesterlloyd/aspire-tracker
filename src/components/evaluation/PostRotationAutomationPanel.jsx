  ...
  return (
    <div style={{ fontFamily: F }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap', marginBottom: 14 }}>
        <h2 style={{ fontSize: 17, fontWeight: 700, color: '#191919', margin: 0 }}>Post-Rotation Evaluation & Certificate</h2>
        <span style={{
      ...
      <p style={{ fontSize: 13, color: '#9ca3af', margin: '0 0 16px', lineHeight: 1.6 }}>
        Release the student post-rotation evaluation after rotation review. Certificate access
        unlocks after the evaluation is submitted. Students appear here at or above their required
