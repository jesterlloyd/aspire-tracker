  ...
  student: (ctx) => ({
    ...
    html: aspireEmailShell({
      ...
      body: `
        ...
        <p style="margin:0 0 16px;">Thank you for submitting your application to ASPIRE at Cedars-Sinai. We&rsquo;ve received your information and your placement coordinator at <strong>${escapeHtml(ctx.school || 'your school')}</strong> has been notified.</p>
    ...
    html: aspireEmailShell({
      ...
      body: `
        ...
        <table style="border-collapse:collapse;margin:16px 0;font-size:14px;">
          ...
          <tr><td style="padding:6px 16px 6px 0;color:#475467;"><strong>School:</strong></td><td>${escapeHtml(ctx.school || 'Not specified')}</td></tr>
          <tr><td style="padding:6px 16px 6px 0;color:#475467;"><strong>Program:</strong></td><td>${escapeHtml(ctx.programType || 'Not specified')}</td></tr>
          <tr><td style="padding:6px 16px 6px 0;color:#475467;"><strong>School Email:</strong></td><td><a href="mailto:${escapeHtml(ctx.studentEmail)}" style="color:${NAVY};">${escapeHtml(ctx.studentEmail)}</a></td></tr>
          <tr><td style="padding:6px 16px 6px 0;color:#475467;"><strong>GPA:</strong></td><td>${escapeHtml(ctx.cumulativeGpa || 'Not provided')}</td></tr>
