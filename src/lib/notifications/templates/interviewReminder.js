...
<p style="margin:0 0 20px;">If you need to reschedule or have a last-minute question, email me directly at <a href="mailto:${JESTER_SIGNATURE.email}" style="color:${NAVY};">${JESTER_SIGNATURE.email}</a> or call <a href="tel:+1${JESTER_PHONE.replace(/\D/g,'')}" style="color:${NAVY};">${JESTER_PHONE}</a>. We'll do our best to work it out.</p>
