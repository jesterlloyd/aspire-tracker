...
export const STYLE_SURFACES = Object.freeze([
  { key: 'home', label: 'At a Glance', material: 'Desk', modern: true },
  { key: 'placementBoard', label: 'Placement Board', material: 'Pinboard', modern: true },
  ...
  { key: 'reviewRelease', label: 'Review & Release', material: 'Clipboard', modern: true },
  { key: 'responses', label: 'Evaluation Responses', material: 'Printout', modern: true },
  ...
  { key: 'catalog', label: 'ASPIRE Catalog', material: 'Bookcase', modern: true },
].map(Object.freeze))
