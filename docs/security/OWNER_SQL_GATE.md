...
| 20260829000000_contacts_divisions.sql | CONTACT-DIVISIONS, 9ba92732, 2026-08-28 | UNKNOWN (row added 2026-09-24, SECURITY-RECORDS-1). Additive: `contacts.divisions`, a checked text[]. Owner-gated; both endpoints probe for the column and answer 503 until it lands (commit body of 9ba92732). No record in this repository proves it applied; confirm with the migration's own verification block. |
...
| 20260922000000_demo_mode_residency.sql | DEMO-MODE-2, 9557b2c7, 2026-09-18 | UNKNOWN (row added 2026-09-24, SECURITY-RECORDS-1). Adds `is_demo` and the inheritance to six ngrp_* tables. No record in this repository proves it applied; confirm with the migration's own verification block. |
...
| 20260923000000_organization_settings.sql | ORGANIZATION-1, 1d79fa60, 2026-09-24 | UNKNOWN (row added 2026-09-24, SECURITY-RECORDS-1). Creates `organization_settings` (RLS on, anon and authenticated revoked), seeds one row, and creates a storage bucket. No record in this repository proves it applied; confirm with the migration's own verification block. |
...
| 20260924010000_organization_application_title.sql | ORGANIZATION-1, bc116911, 2026-09-24 | UNKNOWN (row added 2026-09-24, SECURITY-RECORDS-1). Requires 20260923000000_organization_settings. Confirm with the migration's own verification block. |
| 20260924020000_organization_footer_logo.sql | ORGANIZATION-1, 70efcb12, 2026-09-24 | UNKNOWN (row added 2026-09-24, SECURITY-RECORDS-1). Requires 20260923000000_organization_settings. Confirm with the migration's own verification block. |
