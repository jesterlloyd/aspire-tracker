...
| 20260910000000_fall_winter_capacity_rebalance.sql | CAPACITY-REBALANCE-1, 2026-09-10 | NOT APPLIED, awaiting the Owner. Data only, plus one private backup table (ops_backup.capacity_rebalance_20260910). Pinned to the Owner's D0 discovery of 2026-09-10 (db/audit/fall_winter_capacity_rebalance_discovery.sql); fails closed if anything moved. Verification queries V1 to V4 and the rollback are inline |
