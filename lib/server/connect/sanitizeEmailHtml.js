...
const PHASE1_OPTIONS = {
  // RICH-COMPOSE-2A-0 adds h2/h3 as BARE tags only (no attributes); their locked inline styles are
  // injected server-side in renderContentBlocks.styleHeadings - never accepted from the client.
