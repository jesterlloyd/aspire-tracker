...
<!-- Header: Nightfall, Cedars-Sinai logo left, ASPIRE right -->
  ...
  <table role="presentation" cellpadding="0" cellspacing="0" width="100%"><tr>
    <td align="left" style="vertical-align:middle;">
      <img src="https://aspire-tracker.vercel.app/cs-logo-large.png"
           ...
           style="display:block;height:auto;max-height:42px;width:auto;max-width:150px;border:0;" />
    </td>
    <td align="right" style="vertical-align:middle;text-align:right;">
      <span style="color:#ffffff;font-size:22px;font-weight:700;letter-spacing:4px;line-height:1;">ASPIRE</span>
    </td>
  </tr></table>
</td></tr>

<!-- Cedars-Sinai Red accent line -->
<tr><td style="background:${CS_RED};font-size:0;line-height:0;height:3px;">&nbsp;</td></tr>

<!-- Body -->
<tr><td style="padding:32px 30px;font-size:15px;line-height:1.6;color:${RAVEN};">${content}</td></tr>

<!-- Footer: Nightfall, white text -->
<tr><td style="background:${NIGHTFALL};padding:20px 30px;">
...
function signatureBlock(sig) {
  ...
  const sigImage  = imgUrl
    ? `<img src="${imgUrl}" alt="${name}" width="200" style="display:block;height:auto;max-width:200px;border:0;margin:6px 0 4px;" />`
    : ''
  return `
