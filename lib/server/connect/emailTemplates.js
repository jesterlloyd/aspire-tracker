...
export function buildDirectMessageEmail({ body, bodyFormat = 'text', includeSignature = true, signature = null, organization = null }) {
  ...
  return { html: aspireEmailShell({ body: content, footerNote: CONNECT_FOOTER_NOTE, organization }) }
}
