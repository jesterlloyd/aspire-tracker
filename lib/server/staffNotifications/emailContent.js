...
const ACTOR_ROLE_LABEL = {
  unit_leader: 'Unit Leader', talent_acquisition: 'Talent Acquisition',
  owner_admin: 'Owner/Admin', signer: 'Signer', system: 'System',
}
...
export function buildStaffNotificationEmail(row) {
  ...
  const actorRole = ACTOR_ROLE_LABEL[row.actor_role] || 'Owner/Admin'
