...
// per lib/server/appUrl.js. dest_url is a plain in-app path (e.g. /students/<id>); the not-yet-built
// staff notification surface uses the same path for internal navigation.
