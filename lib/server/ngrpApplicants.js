...
export async function composeCandidateLifecycle(db, candidates) {
  ...
  if (candidates.length) {
    const outRes = await db.from('ngrp_residency_outcomes')
      .select('candidate_id, offer_extended_at, offer_accepted_at, hired_at, hired_unit, residency_start_date, separated_at, separation_reason')
