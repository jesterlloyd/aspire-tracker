...
// NA-PORTAL-UTILITIES-1: nursing_academic joined once the Owner SQL gate widened the DB CHECK.
export const PORTAL_FEEDBACK_ROLES = ['student', 'unit_leader', 'academic_partner', 'nursing_academic'];
