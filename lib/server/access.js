...
const CAPABILITIES = Object.freeze({
  ...
  // NGRP workspace (NGRP-WORKSPACE-1). Initial release is Owner capability,
  // Admin, and Co-Lead only - the product plan's role model (section 4).
  // Interviewer and Viewer have NO general NGRP access; a future assigned
  // NGRP interview will get its own narrower capability, not this one.
  // Access and manage are distinct keys so a later read-only NGRP audience
  // can be introduced without touching call sites.
  ngrp_access:           ['admin', 'co-lead'],
  ngrp_manage:           ['admin', 'co-lead'],
