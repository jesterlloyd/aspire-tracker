...
export function buildCaseyFinkPostRotationInvitationEmail({ studentFirstName, surveyUrl, expiresAtHuman } = {}) {
  ...
  const preheader = 'One final step: complete the Readiness for Practice survey to unlock your Certificate of Participation.';
...
<p style="margin:0 0 16px;">Completing this Readiness for Practice survey unlocks your ASPIRE Certificate of Participation.</p>
