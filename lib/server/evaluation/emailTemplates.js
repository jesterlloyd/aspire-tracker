...
<tr><td style="background:${NAVY};padding:20px 28px;">
  ...
  <div style="color:#ffffff;font-size:11px;opacity:0.85;margin-top:2px;">Brawerman Nursing Institute · Cedars-Sinai Medical Center</div>
</td></tr>
...
export function buildStudentInvitationTestEmail({
  ...
  const subject   = `[TEST] ASPIRE Program: Casey-Fink Pre-Rotation Survey for ${studentFirstName}`;
...
<tr><td style="padding:18px 20px;">
  ...
  <table cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td style="padding:4px 0;font-size:14px;">Casey-Fink Readiness for Practice Survey 2024</td>
    </tr>
    <tr>
