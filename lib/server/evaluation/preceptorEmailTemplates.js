...
function subjectFor(period, studentName) {
  switch (period) {
    case 'midpoint':        return `ASPIRE Midpoint Feedback Requested for ${studentName}`;
    case 'end_of_rotation': return `ASPIRE End-of-Rotation Feedback Requested for ${studentName}`;
    case 'other_interim':
    default:                return `ASPIRE Feedback Requested for ${studentName}`;
  }
}
