...
${safePeriod === 'end_of_rotation' ? `
<!-- PRECEPTOR-CERT-1: the value of completing, stated once, End of Rotation only.
     Recognition framing, not compensation - and midpoint never promises a
     certificate it cannot unlock. -->
<p style="margin:0 0 16px;">Your feedback helps us understand student readiness, strengthen the
preceptorship experience, and improve ASPIRE. <strong>Completing this short assessment also unlocks
your Certificate of Appreciation</strong> in recognition of your contribution as an ASPIRE
preceptor.</p>` : ''}
...
${renderEmailDetailsCard({ title: 'Feedback Request', rows: [
  { label: 'Assessment',        value: SURVEY_NAMES.preceptor_progress },
