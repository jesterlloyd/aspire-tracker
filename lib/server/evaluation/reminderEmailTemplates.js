...
// and preceptor_progress at post_rotation may mention one. Student's Feedback on
// ASPIRE (post_rotation_evaluation) stopped gating a certificate in July 2026 and its
...
const WORKFLOW_COPY = Object.freeze({
  casey_fink_readiness: {
    ...
    lead: `We recently sent you the ${SURVEY_NAMES.casey_fink_readiness_2024} survey, and our records show it is still open.`,
