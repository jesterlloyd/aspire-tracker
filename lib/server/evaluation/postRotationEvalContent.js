...
//
// ASPIRE-POSTROTATION-EVAL-FORM-1 - approved content + validation for Student's Feedback on
// ASPIRE (instrument slug: post_rotation_evaluation, timepoint: post_rotation). The student
...
export const POST_ROTATION_CONTENT = Object.freeze({
  title: SURVEY_NAMES.post_rotation_evaluation,
  intro:
    'Congratulations on completing ASPIRE. Please take a few minutes to reflect on your experience. ' +
    'Your feedback helps us improve ASPIRE for future students and academic partners.',
