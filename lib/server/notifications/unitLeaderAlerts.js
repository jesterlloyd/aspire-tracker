...
// The approved alert types SURFACED TO UNIT LEADERS. This is a SUBSET of the
// database CHECK chk_ulnp_alert_type, which still permits the historical
// 'onboarding_issue' value: a value absent here is simply never produced or offered,
// while the CHECK stays a harmless superset (no migration needed to stop surfacing a
// type). onboarding_issue was removed deliberately: onboarding completion is staff and
// student owned and a Unit Leader cannot act on it, so it is neither shown in the feed
// nor offered as an email preference. Every type here is Unit-Leader-actionable.
