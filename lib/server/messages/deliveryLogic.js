...
// downgrades (a delivered/opened/clicked event never regresses a later state), and
// since S-21 (2026-09-26) never moves sideways either: an equal rank is a no-op, so a
// terminal bounced or complained is never rewritten by the other.
