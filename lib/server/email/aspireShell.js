...
const LOGO_URL = 'https://aspire-tracker.vercel.app/cs-logo-large.png';
const MARK_URL = 'https://aspire-tracker.vercel.app/cs-logo-white-mark.png';
...
export function aspireEmailShell({ body = '', preheader = '' } = {}) {
  return `<!DOCTYPE html>
...
<tr><td style="background:${NIGHTFALL};padding:18px 28px;">
  <table role="presentation" cellpadding="0" cellspacing="0" width="100%"><tr>
    ...
    <td style="vertical-align:top;">
      ...
      <p style="margin:12px 0 0;color:rgba(255,255,255,0.6);font-size:10px;line-height:1.55;">${ASPIRE_NOREPLY_LINE}</p>
    </td>
  </tr></table>
</td></tr>
