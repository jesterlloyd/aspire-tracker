...
export function portalInvitationEmail({ firstName, activationLink, expiresAt, role } = {}) {
  ...
  const expiryLine = expiryText
    ? `<p style="margin:0 0 16px;font-size:13px;color:#6b7280;">This invitation is time-limited and is intended only for you. Please activate your access and create your password by <strong>${esc(expiryText)}</strong>.</p>`
    : ''
