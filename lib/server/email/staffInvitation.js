...
//
// The link lifetime stated here matches the confirmed production Email OTP
// expiration (3600 seconds). Staff access itself has no expiration, so this
...
<p style="margin:0 0 16px;font-size:13px;color:#6b7280;">The activation button is time-limited: it works for 1 hour and can be used once. If it expires, you can request a fresh link yourself from the activation page, or with Forgot password on the sign-in page. Requesting a new link makes earlier links stop working, so always use the newest email.</p>
